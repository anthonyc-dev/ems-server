...
exports.validateLogin = exports.studentValidateRegister = exports.validateRegister = void 0;
...
const validateRegister = (req, res, next) => {
    try {
        ...
        if (!validator_1.default.matches(firstName, /^[a-zA-Z\s]+$/)) {
            res.status(400).json({
        ...
        if (!validator_1.default.matches(lastName, /^[a-zA-Z\s]+$/)) {
            res.status(400).json({
...
const studentValidateRegister = (req, res, next) => {
    try {
        ...
        if (!validator_1.default.matches(program, /^[a-zA-Z\s]+$/)) {
            res.status(400).json({
        ...
        if (!validator_1.default.matches(yearLevel, /^[a-zA-Z0-9\s]+$/)) {
            res.status(400).json({
...
exports.studentValidateRegister = studentValidateRegister;
